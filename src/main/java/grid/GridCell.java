...
public class GridCell implements Renderable {
    ...
    private static final Color BASE_DARK = new Color(17, 17, 40);
    private static final Color BASE_LIGHT = new Color(26, 26, 58);
    ...
    public void render(Graphics2D g) {
        ...
        Color baseColor = isDark ? BASE_DARK : BASE_LIGHT;
